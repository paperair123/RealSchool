...
//      有至少一个掉落物的矿石方块
        addDrop(ModBlocks.GYPSUM_ORE, copperOreLikeDrops(ModBlocks.GYPSUM_ORE,
                ModItems.RAW_GYPSUM));
        addDrop(ModBlocks.BAUXITE_ORE, copperOreLikeDrops(ModBlocks.BAUXITE_ORE,
                ModItems.ALUMINUM_INGOT));
        addDrop(ModBlocks.COPPER_NICKEL_ORE, copperOreLikeDrops(ModBlocks.COPPER_NICKEL_ORE,
